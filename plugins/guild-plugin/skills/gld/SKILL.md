...
- Every command listed above is implemented. (`sprint` is built but **readiness-gated** — it refuses to run autonomously until measured prerequisites pass; see `sprint.md`.)
