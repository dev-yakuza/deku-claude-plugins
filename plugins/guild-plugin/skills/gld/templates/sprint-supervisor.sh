...
# ONE --paginate query returns id AND body together. `_bash_rules.md:124`: needing both and
...
# ─────────────────────────────────────────────────────────────────────────────
# Redirection is used freely here: `_bash_rules.md:122` puts a generated script's own contents
