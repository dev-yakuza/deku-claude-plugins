...
# ONE --paginate query returns id AND body together. `_bash_rules.md:125`: needing both and
...
# ─────────────────────────────────────────────────────────────────────────────
# Redirection is used freely here: `_bash_rules.md:123` puts a generated script's own contents
