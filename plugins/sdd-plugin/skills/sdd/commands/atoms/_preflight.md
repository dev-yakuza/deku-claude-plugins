...
|---|---|---|
| Light | 1 + 2 | `analyze_work`, `test_work`, `implement_pr` |
| Medium | 1 + 2 + 3 | `design_work` |
| Heavy | 1 + 2 + 3 + 4 | `implement_plan` |
| Code-focused | 4 | `implement_red`, `implement_green`, `implement_refactor`, `implement_e2e` |
...
- `sdd:review:shallow` → all atoms run **Light** tier (items 3 and 4 are skipped regardless of default tier)
...
- [ ] Target dir survey: N/A (analyze tier)
